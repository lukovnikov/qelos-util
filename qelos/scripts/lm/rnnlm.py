...
def run(lr=20.,
    ...
    train_batch_f = q.train_batch(on_before_optim_step=[lambda: torch.nn.utils.clip_grad_norm_(m.parameters(), gradnorm)], _retpartial=True)
